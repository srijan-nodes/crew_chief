...
{
    /// <summary>
    /// Spotter implementation for F1 2022
    /// </summary>
    class F12022Spotter : Spotter
    {
        private const float twoPi = (float)(2 * Math.PI);

        public F12022Spotter(AudioPlayer audioPlayer, bool initialEnabledState)
        {
            this.audioPlayer = audioPlayer;
            this.enabled = initialEnabledState;
            this.initialEnabledState = initialEnabledState;
            this.internalSpotter = new NoisyCartesianCoordinateSpotter(audioPlayer, true, UserSettings.GetUserSettings().getFloat("f1_2022_spotter_car_length"), 2);
        }
        ...
        {
            F12022StructWrapper currentWrapper = currentStateObj as F12022StructWrapper;
        ...
        private void MakeSpotterDoItsJob(F12022StructWrapper data)
        {
            // Get drivers data
        ...
        private List<OpponentSpatialData> GetOpponentsData(F12022StructWrapper data, in PlayerSpatialData playerData)
        {
