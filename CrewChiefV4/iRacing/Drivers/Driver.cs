...
namespace CrewChiefV4.iRacing
{
    ...
    public partial class Driver
    {
        ...
        public void ParseDynamicSessionInfo(string sessionInfo, bool isPlayerCar)
        {
            ...
            this.FlairName = ParseDriverYaml(sessionInfo, "FlairName");
            this.EstimatedLapTime = Parser.ParseFloat(ParseDriverYaml(sessionInfo, "CarClassEstLapTime"));
            this.Incidents = Parser.ParseInt(ParseDriverYaml(sessionInfo, "CurDriverIncidentCount"));
            this.LicensLevelString = ParseDriverYaml(sessionInfo, "LicString");
            this.licensLevel = Parser.ParseLicens(LicensLevelString);
            this.DivisionName = ParseDriverYaml(sessionInfo, "DivisionName");
        ...
        public void ParseStaticSessionInfo(string sessionInfo, bool isPlayerCar)
        {
            ...
            this.IsCarAi = Parser.ParseInt(ParseDriverYaml(sessionInfo, "CarIsAI")) == 1;
        ...
        internal void UpdateLiveInfo(iRacingData e, string sessionType)
        {
            this.Live.ParseTelemetry(e, sessionType);
        }
    }
}
