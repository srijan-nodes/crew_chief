...
namespace CrewChiefV4.assetto128
{
    class ACS128Spotter : Spotter
    {
        ...
        public ACS128Spotter(AudioPlayer audioPlayer, Boolean initialEnabledState)
        {
        ...
        {
            AssettoCorsaShared latestRawData = ((ACS128SharedMemoryReader.ACSStructWrapper)currentStateObj).data;
            ...
            int numCars = Math.Min(latestRawData.acsChief.numVehicles, assettoConstant.MaxVehicles);
        ...
        public override void trigger(Object lastStateObj, Object currentStateObj, GameStateData currentGameState)
        {
            ...
            AssettoCorsaShared currentState = ((ACS128SharedMemoryReader.ACSStructWrapper)currentStateObj).data;
            AssettoCorsaShared lastState = ((ACS128SharedMemoryReader.ACSStructWrapper)lastStateObj).data;
            ...
            if (currentPlayerData.isCarInPitline == 0 || currentPlayerData.isCarInPit == 0)
            {
                ...
                for (int i = 0; i < Math.Min(currentState.acsChief.numVehicles, assettoConstant.MaxVehicles); i++)
                {
