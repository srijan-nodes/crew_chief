using CrewChiefV4.assetto128.assettoData;
...
namespace CrewChiefV4.assetto128
{
    public class ACS128GameStateMapper : GameStateMapper
    {
        ...
        private readonly Boolean logUnknownTrackSectors = UserSettings.GetUserSettings().getBoolean("enable_acs_log_sectors_for_unknown_tracks");

        private readonly Boolean disableYellowFlag = UserSettings.GetUserSettings().getBoolean("disable_acs_yellow_flag_warnings");

        private readonly int singleplayerPracticTime = UserSettings.GetUserSettings().getInt("acs_practice_time_minuts");
        ...
        static string defaultTyreName;
		
        #region WaYToManyTyres
        public ACS128GameStateMapper()
        {
            acTyres.Clear();
            ...
            tyreWearThresholdsGP57.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.0f));
            tyreWearThresholdsGP57.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.0f, 10.0f));
            tyreWearThresholdsGP57.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 10.0f, 40.0f));
            tyreWearThresholdsGP57.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 40.0f, 55.49493f));
            tyreWearThresholdsGP57.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 55.49493f, 1000f));
            ...
            tyreWearThresholdsGP63.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.0f));
            tyreWearThresholdsGP63.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.0f, 10.0f));
            tyreWearThresholdsGP63.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 10.0f, 40.0f));
            tyreWearThresholdsGP63.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 40.0f, 55.49493f));
            tyreWearThresholdsGP63.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 55.49493f, 1000f));
            ...
            tyreWearThresholdsGP67.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.0f));
            tyreWearThresholdsGP67.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.0f, 10.0f));
            tyreWearThresholdsGP67.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 10.0f, 40.0f));
            tyreWearThresholdsGP67.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 40.0f, 55.49493f));
            tyreWearThresholdsGP67.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 55.49493f, 1000f));
            ...
            acTyres.Add("Hard GP70 (H)", new AcTyres(tyreWearThresholdsGP70H, tyreTempsThresholdsGP70H, 95f));
            ...
            defaultTyreName = "Slicks Medium (M)";
            ...
            //VRC Formula Alpha 2023 tyres
            List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniUltraSoft = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 3.685061f));
            tyreWearThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 3.685061f, 7.407379f));
            tyreWearThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 7.407379f, 72.5275f));
            tyreWearThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 72.5275f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsPioraniUltraSoft = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 50f));
            tyreTempsThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 50f, 80f));
            tyreTempsThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 80f, 140f));
            tyreTempsThresholdsPioraniUltraSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 140f, 10000f));
            acTyres.Add("Piorani US (C5)", new AcTyres(tyreWearThresholdsPioraniUltraSoft, tyreTempsThresholdsPioraniUltraSoft, 88f));
			

			List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniSuperSoft = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 3.685061f));
            tyreWearThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 3.685061f, 7.407379f));
            tyreWearThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 7.407379f, 72.5275f));
            tyreWearThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 72.5275f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsPioraniSuperSoft = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 50f));
            tyreTempsThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 50f, 80f));
            tyreTempsThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 80f, 140f));
            tyreTempsThresholdsPioraniSuperSoft.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 140f, 10000f));
            acTyres.Add("Piorani SS (C4)", new AcTyres(tyreWearThresholdsPioraniSuperSoft, tyreTempsThresholdsPioraniSuperSoft, 88f));


            List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniSoft = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 3.685061f));
            tyreWearThresholdsPioraniSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 3.685061f, 14.96601f));
            tyreWearThresholdsPioraniSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 14.96601f, 46.8085f));
            tyreWearThresholdsPioraniSoft.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 46.8085f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsSoftPiorani = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsSoftPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 70f));
            tyreTempsThresholdsSoftPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 70f, 85f));
            tyreTempsThresholdsSoftPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 85f, 100f));
            tyreTempsThresholdsSoftPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 100f, 10000f));
            acTyres.Add("Piorani S (C3)", new AcTyres(tyreWearThresholdsPioraniSoft, tyreTempsThresholdsSoftPiorani, 88f));


            List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniMedium = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniMedium.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniMedium.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 3.685061f));
            tyreWearThresholdsPioraniMedium.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 3.685061f, 14.96601f));
            tyreWearThresholdsPioraniMedium.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 14.96601f, 30.55553f));
            tyreWearThresholdsPioraniMedium.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 30.55553f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsMediumPiorani = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsMediumPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 90f));
            tyreTempsThresholdsMediumPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 90f, 115f));
            tyreTempsThresholdsMediumPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 115f, 140f));
            tyreTempsThresholdsMediumPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 140f, 10000f));
            acTyres.Add("Piorani M (C2)", new AcTyres(tyreWearThresholdsPioraniMedium, tyreTempsThresholdsMediumPiorani, 88f));


            List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniHard = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniHard.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniHard.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 14.96601f));
            tyreWearThresholdsPioraniHard.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 14.96601f, 22.68041f));
            tyreWearThresholdsPioraniHard.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 22.68041f, 30.55553f));
            tyreWearThresholdsPioraniHard.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 30.55553f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsHardPiorani = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsHardPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 75f));
            tyreTempsThresholdsHardPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 75f, 100f));
            tyreTempsThresholdsHardPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 100f, 180f));
            tyreTempsThresholdsHardPiorani.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 180f, 10000f));
            acTyres.Add("Piorani H (C1)", new AcTyres(tyreWearThresholdsPioraniHard, tyreTempsThresholdsHardPiorani, 88f));


            List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniSuperHard = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 1.469612f));
            tyreWearThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 1.469612f, 22.68041f));
            tyreWearThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 22.68041f, 30.55553f));
            tyreWearThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 30.55553f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsPioraniSuperHard = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 85f));
            tyreTempsThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 85f, 110f));
            tyreTempsThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 110f, 160f));
            tyreTempsThresholdsPioraniSuperHard.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 160f, 10000f));
            acTyres.Add("Piorani SSH (C0)", new AcTyres(tyreWearThresholdsPioraniSuperHard, tyreTempsThresholdsPioraniSuperHard, 88f));
			

			List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniInter = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 1.469612f));
            tyreWearThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 1.469612f, 22.68041f));
            tyreWearThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 22.68041f, 30.55553f));
            tyreWearThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 30.55553f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsPioraniInter = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 85f));
            tyreTempsThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 85f, 110f));
            tyreTempsThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 110f, 160f));
            tyreTempsThresholdsPioraniInter.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 160f, 10000f));
            acTyres.Add("Piorani Inter (INT)", new AcTyres(tyreWearThresholdsPioraniInter, tyreTempsThresholdsPioraniInter, 88f));
			

			List<CornerData.EnumWithThresholds> tyreWearThresholdsPioraniWet = new List<CornerData.EnumWithThresholds>();
            tyreWearThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreCondition.NEW, -10000f, 0.000f));
            tyreWearThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreCondition.SCRUBBED, 0.000f, 1.469612f));
            tyreWearThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreCondition.MINOR_WEAR, 1.469612f, 22.68041f));
            tyreWearThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreCondition.MAJOR_WEAR, 22.68041f, 30.55553f));
            tyreWearThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreCondition.WORN_OUT, 30.55553f, 1000f));

            List<CornerData.EnumWithThresholds> tyreTempsThresholdsPioraniWet = new List<CornerData.EnumWithThresholds>();
            tyreTempsThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreTemp.COLD, -10000f, 85f));
            tyreTempsThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreTemp.WARM, 85f, 100f));
            tyreTempsThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreTemp.HOT, 100f, 160f));
            tyreTempsThresholdsPioraniWet.Add(new CornerData.EnumWithThresholds(TyreTemp.COOKING, 160f, 10000f));
            acTyres.Add("Piorani Wet (WET)", new AcTyres(tyreWearThresholdsPioraniWet, tyreTempsThresholdsPioraniWet, 88f));
        }
        #endregion
        ...
        public override void versionCheck(Object memoryMappedFileStruct)
        {
            ...
            AssettoCorsaShared shared = ((ACS128SharedMemoryReader.ACSStructWrapper)memoryMappedFileStruct).data;
        ...
        {
            ACS128SharedMemoryReader.ACSStructWrapper wrapper = (ACS128SharedMemoryReader.ACSStructWrapper)memoryMappedFileStruct;
            ...
            ACS128GameStateMapper.numberOfSectorsOnTrack = currentGameState.SessionData.TrackDefinition.sectorsOnTrack;
                            ...
                            (currentGameState.SessionData.SessionHasFixedTime && sessionTimeRemaining > lastSessionTimeRemaining + 1))))
            {
                ...
                if (acTyres.Count > 0)
                {
                    if (!acTyres.ContainsKey(shared.acsGraphic.tyreCompound))
                    {
                        Log.Warning("Player is using unknown Tyre Type " + shared.acsGraphic.tyreCompound);
                        shared.acsGraphic.tyreCompound = acTyres.ContainsKey(defaultTyreName) ? defaultTyreName : acTyres.First().Key;
                        Log.Commentary("Assuming Tyre Type " + shared.acsGraphic.tyreCompound);
                    }
                    else
                    {
            ...
            else
            {
                ...
                if (currentGameState.SessionData.IsNewLap)
                {
                    ...
                    currentGameState.SessionData.playerCompleteLapWithProvidedLapTime(currentGameState.SessionData.OverallPosition, currentGameState.SessionData.SessionRunningTime,
                        ...
                        currentGameState.SessionData.SessionTimeRemaining, ACS128GameStateMapper.numberOfSectorsOnTrack, currentGameState.TimingData, null, null);
                ...
                /*previousGameState != null && previousGameState.SessionData.IsNewLap == false &&
                    ...
                    && (currentGameState.SessionData.SessionPhase == SessionPhase.Green || currentGameState.SessionData.SessionPhase == SessionPhase.FullCourseYellow)));
                */
                currentGameState.SessionData.DeltaTime.SetNextDeltaPoint(distanceRoundTrack, currentGameState.SessionData.CompletedLaps, playerVehicle.speedMS, currentGameState.Now, shared.acsGraphic.isInPitLane != 1);
                if (previousGameState != null)
                {
                        ...
                        if (currentOpponentData != null)
                        {
                            if (participantStruct.isConnected == 1)
                            {
                                ...
                                if (previousGameState != null)
                                {
                                    ...
                                    Boolean isEnteringPits = participantStruct.isCarInPitline == 1 && currentOpponentSector == ACS128GameStateMapper.numberOfSectorsOnTrack;
            ...
            currentGameState.FuelData.FuelMultiplier = (int)shared.acsStatic.aidFuelRate;
            ...
            Boolean currentTyreValid = acTyres.Count > 0; // either it's in the dictionary or we'll just use the default
            if (currentTyreValid)
            {
                if (!acTyres.ContainsKey(shared.acsGraphic.tyreCompound))
                {
            ...
            if (currentTyreValid)
            {
                ...
                currentGameState.TyreData.FrontRightPercentWear = getTyreWearPercentage(shared.acsPhysics.tyreWear[1], currentTyreWearMinimumValue);
                currentGameState.TyreData.RearLeftPercentWear = getTyreWearPercentage(shared.acsPhysics.tyreWear[2], currentTyreWearMinimumValue);
                currentGameState.TyreData.RearRightPercentWear = getTyreWearPercentage(shared.acsPhysics.tyreWear[3], currentTyreWearMinimumValue);
            ...
            TimingData timingData, CarData.CarClass playerCarClass)
        {
            ...
            bool hasCrossedSFline = opponentData.CurrentSectorNumber == ACS128GameStateMapper.numberOfSectorsOnTrack && sector == 1;
            ...
            if (opponentData.CurrentSectorNumber == ACS128GameStateMapper.numberOfSectorsOnTrack && sector == ACS128GameStateMapper.numberOfSectorsOnTrack && (!lapIsValid || !validSpeed))
            {
                    ...
                    if (opponentData.OpponentLapData.Count > 0)
                    {
                        ...
                        else
                        {
                            opponentData.CompleteLapWithProvidedLapTime(leaderBoardPosition, sessionRunningTime, lastLapTime, isInPits,
                                false, trackTempreture, airTemperature, sessionLengthIsTime, sessionTimeRemaining, ACS128GameStateMapper.numberOfSectorsOnTrack,
            ...
            if (sector == ACS128GameStateMapper.numberOfSectorsOnTrack && isInPits)
            {
