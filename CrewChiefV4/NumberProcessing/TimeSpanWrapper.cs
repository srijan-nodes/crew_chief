...
namespace CrewChiefV4.NumberProcessing
{
    public class TimeSpanWrapper
    {
        ...
        public TimeSpanWrapper(TimeSpan timeSpan, Precision precision)
        {
            ...
            if (precision == Precision.AUTO_LAPTIMES && GlobalBehaviourSettings.noMinutesInLapTimes)
            {
                this.timeSpan = new TimeSpan(0, 0, 0, timeSpan.Seconds, timeSpan.Milliseconds);
            }
