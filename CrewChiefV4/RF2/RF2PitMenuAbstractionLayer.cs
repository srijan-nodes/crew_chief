...
namespace UnitTest
{
    ...
    {
        public static Rf2PitMenuController.PitMenuContents pitMenu
        {
            get { return RF2PitMenuAbstractionLayer.inst.menuLayout.menuDict; }
            set
            {
                RF2PitMenuAbstractionLayer.inst.menuLayout = new RF2PitMenuAbstractionLayer.MenuLayout();
                RF2PitMenuAbstractionLayer.inst.menuLayout.Set(value);
            }
        }
    }
}
namespace CrewChiefV4.RF2
{
    ...
    /// </summary>
    public class RF2PitMenuAbstractionLayer : IPitMenuAbstractionLayer //: PitMenuController
    {
        ...
        internal static RF2PitMenuAbstractionLayer inst { get; private set; }
        public IPitMenuController pmc { get; set; }

        public RF2PitMenuAbstractionLayer()
        {
            inst = this;
            pmc = new Rf2PitMenuController();
        }
        ...
        {
            return 1f;      // Not implemented in rF2
        }
        ...
        {
            return true;    // Not implemented in rF2
        }
        public int GetVirtualEnergy()
        {
            return 100;     // Not implemented in rF2
        } 
        ...
        internal class MenuLayout
        {
            ...
            internal Rf2PitMenuController.PitMenuContents menuDict =
                new Rf2PitMenuController.PitMenuContents();

            private static readonly IPitMenuController pmc = new Rf2PitMenuController();
