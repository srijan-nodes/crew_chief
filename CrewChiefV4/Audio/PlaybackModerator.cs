...
namespace CrewChiefV4.Audio
{
    ...
    public static class PlaybackModerator
    {
        ...
        private static readonly bool insertBeepOutBetweenSpotterAndChief = UserSettings.GetUserSettings().getBoolean("insert_beep_out_between_spotter_and_chief");
        private static readonly bool insertBeepInBetweenSpotterAndChief = UserSettings.GetUserSettings().getBoolean("insert_beep_in_between_spotter_and_chief");
        public static readonly bool rejectMessagesWhenTalking = UserSettings.GetUserSettings().getBoolean("reject_message_when_talking");
        private static readonly bool autoVerbosity = UserSettings.GetUserSettings().getBoolean("priortise_messages_depending_on_situation");
        private static readonly bool respondWhileChannelIsStillOpen = UserSettings.GetUserSettings().getBoolean("sre_respond_while_channel_still_open");
        public static readonly bool paceNotesMuteOtherMessages = UserSettings.GetUserSettings().getBoolean("pace_notes_mute_all_messages");
        ...
        private static void Trace(string msg)
        {
            ...
            Log.SoundDebug(string.Format("PlaybackModerator: {0}", msg));
        }
