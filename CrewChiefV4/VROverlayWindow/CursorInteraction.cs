...
#pragma warning restore 649
        ...
        public static void CursorSendInput(IntPtr wndHandle, SimulationMode mode, ClickAPI api, Point clickPoint, int delta)
        {
            Point oldPos;
            IntPtr lPrm;
            switch (api)
        ...
        public static Point GetCursorPosRelativeWindow(IntPtr wndHandle)
        {
            ...
            RECT rect = new RECT();
            Win32Stuff.GetWindowRect(wndHandle, ref rect);
            p.X -= rect.Left;
            p.Y -= rect.Top;
        ...
        public static Point GetCursorPosRelativeWindow(SharpDX.Rectangle rect)
        {
            var p = Cursor.Position;
            p.X -= rect.Left;
            p.Y -= rect.Top;
