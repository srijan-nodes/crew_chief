// This is based on https://github.com/ValveSoftware/openvr/releases/tag/v1.16.8 2021-02-25
// (identified by the version number in openvr_api.dll)
// Current is https://github.com/ValveSoftware/openvr/releases/tag/v2.5.1 2024-03-27
...
public class OpenVR
{
	...
	public static bool IsRuntimeInstalled()
	{
        ...
        {
            Log.Error($"OpenVR.IsRuntimeInstalled error: {e.Message}");
        }
        return false;
    }
