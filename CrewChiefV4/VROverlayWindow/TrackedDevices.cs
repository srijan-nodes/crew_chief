...
namespace CrewChiefV4.VirtualReality
{
    ...
    public class TrackedDevices
    {
        public class Controller
        {
            ...
            {
                PreviousState = State;
                Valve.VR.OpenVR.System.GetControllerState(ControllerIndex, ref State, sizeVRControllerState_t);
            }
        }
        ...
        public static unsafe void GetProjection(int eyeIndex, float near, float far, out Matrix projection)
        {
