...
{
    public class AMS2UDPreader : GameDataReader
    {        
        ...
        private List<CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper> dataToDump;
        private CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper[] dataReadFromFile = null;
        private int dataReadFromFileIndex = 0;
        private readonly int udpPort = UserSettings.GetUserSettings().getInt("udp_data_port");

        private ams2APIStruct workingGameState = new ams2APIStruct();
        private ams2APIStruct currentGameState = new ams2APIStruct();
        private ams2APIStruct previousGameState = new ams2APIStruct();
        ...
        public override void DumpRawGameData()
        {
            ...
            {
                SerializeObject(dataToDump.ToArray<CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper>(), filenameToDump);
            }
        }
        ...
        public override TracedGameData ReadGameDataFromFile(String filename, int pauseBeforeStart)
        {
            if (dataReadFromFile == null || filename != lastReadFileName)
            {
                ...
                dataReadFromFile = DeSerializeObject<CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper[]>(filePathResolved);
                lastReadFileName = filename;
                Thread.Sleep(pauseBeforeStart);
            }
            if (dataReadFromFile != null && dataReadFromFile.Length > dataReadFromFileIndex)
            {
                CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper structWrapperData = dataReadFromFile[dataReadFromFileIndex];
        ...
        protected override Boolean InitialiseInternal()
        {
            if (!this.initialised)
            {
                ...
                if (dumpToFile)
                {
                    dataToDump = new List<CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper>();
                }
        ...
        {
            CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper structWrapper = new CrewChiefV4.AMS2.AMS2SharedMemoryReader.AMS2StructWrapper();
            ...
            if (!forSpotter && currentlyTracingGameData && dataToDump != null && currentGameState.mTrackLocation != null &&
