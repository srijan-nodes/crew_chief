...
namespace GameOverlay.PInvoke
{
    ...
    public static class WindowNativeMethods
    {
        ...
        {
            return unchecked((short)(((uint)GetIntUnchecked(dwValue)) >> 16));
        }
        public static int LOWORD(IntPtr dwValue)
        {
            return unchecked((short)GetIntUnchecked(dwValue));
        }
        public static int GET_WHEEL_DELTA_WPARAM(IntPtr wParam)
        {
            return (short)HIWORD(wParam);
        }
        public static int GET_X_LPARAM(IntPtr wParam)
        {
            return (short)LOWORD(wParam);
        } 
        public static int GET_Y_LPARAM(IntPtr wParam)
        {
            return (short)HIWORD(wParam);
        }
